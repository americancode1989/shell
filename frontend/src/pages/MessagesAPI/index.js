  ...
  return (
    ...
    >
      ...
      <Typography className={classes.elementMargin} component="div">
        ...
        <ul>
          <li>Antes de enviar mensajes, es necesario registrar el token vinculado a la conexión que enviará los mensajes. <br/>Para realizar el registro, accede al menú "Conexiones", haz clic en el botón editar de la conexión e inserta el token en el campo correspondiente.</li>
          <li>
            El número para envío no debe tener máscara ni caracteres especiales y debe estar compuesto por:
              <ul>
                <li>Código del país</li>
                <li>Código de marcación</li>
                <li>Número</li>
              </ul>
          </li>
        </ul>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación, la lista de información necesaria para enviar los mensajes de texto:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
            <b>Headers: </b> X_TOKEN (token registrado) Tipo de contenido (application/json) <br />
            <b>Body: </b> {"{ \"número\": \"18293224999\", \"body\": \"Tu mensaje\" }"}
          </Typography>
        </Grid>
        <Grid item xs={12} sm={6}>
      ...
      <Grid container>
        <Grid item xs={12} sm={6}>
          <Typography className={classes.elementMargin} component="div">
            <p>A continuación se detalla la lista de información necesaria para el envío de mensajes de texto:</p>
            <b>Endpoint: </b> {getEndpoint()} <br />
            <b>Método: </b> POST <br />
