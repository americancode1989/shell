...
const PromptSchema = Yup.object().shape({
    name: Yup.string().min(5, "¡Muy corto!").max(100, "Muito longo!").required("Obligatorio"),
    prompt: Yup.string().min(50, "¡Muy corto!").required("Descreva o treinamento para Inteligência Artificial"),
    voice: Yup.string().required("Informe el modo para Voz"),
    max_tokens: Yup.number().required("Informe el número máximo de tokens."),
    temperature: Yup.number().required("Informe la temperatura"),
    apikey: Yup.string().required("Informe la clave de API"),
    queueId: Yup.number().required("Informe de fila"),
    max_messages: Yup.number().required("Informe el número máximo de mensajes")
});
